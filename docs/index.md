...
- Optionally dispatch rendered report exports to external HTTP endpoints, S3, GCS, BigQuery, or Snowflake (`gcs` supports all non-table formats; `bigquery`/`snowflake` are NDJSON-only)
