...
- [x] Build model adapter layer (src/llm_behavior_diff/adapters/)
  ...
  - adapters/litellm_adapter.py — Planned
  - adapters/local_adapter.py — Planned
...
- [x] Implement test runner (src/llm_behavior_diff/runner.py)
  ...
  - Progress bar with rich (remaining enhancement)
...
- [x] LLM-as-judge comparator mode (optional, metadata-only)
- [x] Statistical significance layer / confidence interval reporting
...
- [x] Build report generator (baseline in CLI formatters)
  ...
  - AC: Advanced visual/reporter module enhancements pending
